jQuery.fn.extend({
  IconSelectBox: function (img) {
    ...
    var getStorage = function () {
      ...
      if (lastSelected) {
        ...
        $(prefix_class + "-select-box").html(
          lastSelected + ' <i data-arrow="true" class="fa fa-angle-down"></i>'
        );
        ...
        $(prefix_class + "-select-box").html(
          optionArray[0] + ' <i data-arrow="true" class="fa fa-angle-down"></i>'
        );
    ...
    $(prefix_class + "-a li").click(function () {
      ...
      $(prefix_class + "-select-box").html(
        item + '<i data-arrow="true" class="fa fa-angle-down"></i>'
      );
